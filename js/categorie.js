...
var CATEGORIE = [
  ...
  { nome: 'Amichevoli',       icona: '<circle cx="12" cy="12" r="4"/><path d="M12 3v2"/><path d="M12 19v2"/><path d="M3 12h2"/><path d="M19 12h2"/><path d="M6 6l1.4 1.4"/><path d="M16.6 16.6L18 18"/><path d="M18 6l-1.4 1.4"/><path d="M7.4 16.6L6 18"/>', base: '#4d7c0f', chiaro: '#7fae1b' },
  { nome: 'Serie A',          icona: '<rect x="4" y="6" width="16" height="14" rx="2"/><path d="M8 3v4"/><path d="M16 3v4"/><path d="M4 11h16"/>', base: '#1f2937', chiaro: '#4b5563' },
  ...
  { nome: 'Coppa Italia',     icona: '<path d="M8 4h8v4.6a4 4 0 0 1-8 0V4z"/><path d="M8 5.4H5v1.8a3 3 0 0 0 3 3"/><path d="M16 5.4h3v1.8a3 3 0 0 1-3 3"/><path d="M12 12.6V17"/><path d="M8.5 20h7"/>', base: '#0e7490', chiaro: '#22a6c3' },  
